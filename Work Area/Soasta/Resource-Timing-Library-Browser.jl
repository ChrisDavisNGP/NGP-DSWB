...
chartConversionsByBrowser(startTime, endTime);
...
chartResourceStats(domain, startTime, endTime; dimension = BROWSER);
...
chartLoadTimeStats(startTime, endTime; dimension = BROWSER, url = domain, isFirstParty = false);
...
chartResources(startTime, endTime; browser = browser, minResourceCount = 5_000, outputFile = file);
...
chartResourceTrend(worstResource, startTime, endTime, datepart; browser = browser, outputFile = file);
...
chartResourceTrend(worstResource, startTime, endTime, datepart; browser = browser, percentiles = AbstractFloat[0.5, 0.75, 0.9])
